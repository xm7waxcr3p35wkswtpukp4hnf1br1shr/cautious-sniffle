...
function FragmentLogo() {
  return (
    <svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        d="M8 10h10v3H11v2.5h6v3h-6V23H8V10z"
        fill="white"
      />
      <path
        d="M20 10h4v13h-4V10z"
        fill="white"
        opacity="0.6"
      />
    </svg>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            ...
            <button
              ...
              style={{
                background: showHistory ? "rgba(61,171,245,0.12)" : "transparent",
                border: `1px solid ${showHistory ? "rgba(61,171,245,0.3)" : "var(--border-color)"}`,
                borderRadius: "7px",
                padding: "5px 12px",
            ...
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                <path
                  d="M12 8v4l3 3M12 21a9 9 0 1 1 0-18 9 9 0 0 1 0 18z"
                  stroke="currentColor"
                  strokeWidth="2"
                  strokeLinecap="round"
                />
      ...
      >
        ...
        <div
          style={{
            ...
            height: "400px",
            background:
              "radial-gradient(ellipse at center, rgba(0,152,234,0.08) 0%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          <div
            style={{
              ...
              alignItems: "center",
              gap: "6px",
              background: "rgba(61,171,245,0.08)",
              border: "1px solid rgba(61,171,245,0.2)",
              borderRadius: "20px",
              padding: "4px 12px",
              fontSize: "12px",
          ...
          >
            ...
            <span style={{ color: "var(--accent-blue)" }}>Availability</span>
          </h1>
          <p
            style={{
              fontSize: "16px",
          ...
          {(["single", "batch"] as const).map((m) => (
            <button
              ...
              style={{
                ...
                border: "none",
                background:
                  mode === m ? "rgba(61,171,245,0.15)" : "transparent",
        ...
        {mode === "single" && (
          <div>
            ...
            >
              ...
              />
              <button
                onClick={() => void checkSingle()}
                disabled={loading || !input.trim()}
                style={{
                  background: loading
                    ? "rgba(61,171,245,0.15)"
                    : "linear-gradient(135deg, #3dabf5 0%, #0098ea 100%)",
                  color: "white",
                  border: "none",
                  borderRadius: "9px",
                  padding: "10px 22px",
            ...
            >
              ...
              to check · 3–32 characters · letters, numbers, underscores
            </p>
            ...
            {result && !error && (
              <div
                ...
                style={{
                  background: "var(--bg-card)",
                  border: `1px solid ${getStatusConfig(result.status).border}`,
                  borderRadius: "14px",
                  padding: "24px",
                  boxShadow: `0 4px 32px ${getStatusConfig(result.status).bg}`,
                }}
              >
                <div
                  style={{
                ...
                >
                  ...
                  {result.photo ? (
                    ...
                    <div
                      style={{
                        ...
                        height: "56px",
                        borderRadius: "50%",
                        background: "linear-gradient(135deg, #3dabf5 0%, #0052a3 100%)",
                        display: "flex",
                        alignItems: "center",
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    >
                      <a
                        href={`https://fragment.com/username/${result.username}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        style={{
                          display: "inline-flex",
                          ...
                          border: "1px solid rgba(61,171,245,0.25)",
                          borderRadius: "7px",
                          padding: "6px 12px",
                          color: "var(--accent-blue)",
                          textDecoration: "none",
          ...
          <div>
            ...
            >
              ...
              >
                ...
                >
                  Enter usernames (one per line, comma or semicolon separated)
                </span>
            ...
            <button
              ...
              style={{
                ...
                fontSize: "15px",
                fontWeight: 600,
                cursor: loading || !batchInput.trim() ? "not-allowed" : "pointer",
                opacity: !batchInput.trim() ? 0.5 : 1,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                gap: "8px",
            ...
            {batchResults.length > 0 && (
              <div className="animate-fade-in">
                ...
                >
                  {(
                    ["Available", "Taken", "For Sale", "Sold", "Unknown"] as const
                  ).map((s) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          style={{ fontSize: "11px", color: cfg.color, opacity: 0.8 }}
                        >
                          {cfg.label}
                        </div>
                      </div>
                      ...
                      {r.photo ? (
                        ...
                        <div
                          style={{
                            ...
                            borderRadius: "50%",
                            background:
                              "linear-gradient(135deg, #3dabf5 0%, #0052a3 100%)",
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                            fontSize: "14px",
                ...
                {history.map((item, i) => (
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        @{item.username}
                        {item.hasPremium === "true" && <PremiumStar />}
                      </div>
                    ...
                    <a
                      href={`https://fragment.com/username/${item.username}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{
                        color: "var(--text-muted)",
